...
const DBUS_NAME: &str = "org.udalenka.udalenka";
...
/// `dbus-send --session --print-reply --dest=org.udalenka.udalenka /dbus org.udalenka.udalenka.NewConnection string:'PEER_ID'`
